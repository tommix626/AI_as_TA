...
builder_output = builder.execute(goal=initial_thinker_input, thinker_output=thinker_output, max_retry_times=10)
print("Builder Output:", builder_output)


constructor_output = constructor.execute(goal=initial_thinker_input+thinker_output, builder_output = builder_output, max_retry_times=10)
